(function($,layer){
	...
	clds_layer = {
		msg: function(a, b, c){   //a:信息   b:info、error、warn
			...
			if(b=="info"){
				layer.msg(a, {icon:1, time:3500, shade:[0], shadeClose: true}, callback);
			}else if(b=="error"){
				layer.msg(a, {icon:2, time:3500, shade:[0], shadeClose: true}, callback);
			}else if(b=="warn"){
				layer.msg(a, {icon:7, time:3500, shade:[0], shadeClose: true}, callback);
			}
		},
